 ...
 *
 */
public class OldCustomPriorityQueue implements Iterable<LabQueue.MarkingRequest> {
     ...
     */
    public OldCustomPriorityQueue(int initCapacity) {
...
//        logger.info("Heap after deletion: " + pq);
    ...
    private class HeapIterator implements Iterator<LabQueue.MarkingRequest> {
        // create a new pq
        private final OldCustomPriorityQueue copy;

        // add all elements to copy of heap
        // takes linear time since already in heap order so no keys move
        public HeapIterator() {
            logger.info("Original pq:" + pq);
            copy = new OldCustomPriorityQueue(pq.size());

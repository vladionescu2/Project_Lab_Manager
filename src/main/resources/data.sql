...
INSERT INTO LAB_FORMAT_LAB_EXERCISES(LAB_FORMAT_REPO_NAMING_SCHEMA, LAB_EXERCISES, LAB_EXERCISES_KEY) VALUES
    ('COMP0_Lab', DATEADD('ww', -1, DATEADD('hh', 18, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 4, today))), 'ex_1'),
    ('COMP0_Lab', DATEADD('ww', 2, DATEADD('hh', 18, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 4, today))), 'ex_2'),
    ('COMP0_Lab', DATEADD('ww', 4, DATEADD('hh', 18, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 4, today))), 'ex_3'),
    ('COMP1_Lab', DATEADD('ww', 3, DATEADD('hh', 14, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 2, today))), 'ex_1'),
    ('COMP1_Lab', DATEADD('ww', 5, DATEADD('hh', 14, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 3, today))), 'ex_2'),
    ('COMP1_Lab', DATEADD('ww', 9, DATEADD('hh', 14, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7), today))), 'ex_3'),
    ('COMP2_Lab', DATEADD('ww', 4, DATEADD('hh', 12, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 2, today))), 'ex_1'),
    ('COMP2_Lab', DATEADD('ww', 5, DATEADD('hh', 12, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 2, today))), 'ex_2'),
    ('COMP2_Lab', DATEADD('ww', 6, DATEADD('hh', 12, DATEADD('dd', -((DAY_OF_WEEK(today) - 2) % 7) + 2, today))), 'ex_3');
